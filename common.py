...
#       te_list = cmn.dat.get_dispatch_by_watch(
#           watch_id_start, watch_id_end)
#       cmn.add_time_entries(time_dict, te_list)
...
#               date_st = j.service_date.strftime(
#                   cmn.stns.get_format_date())
...
#       logging.info(f"Adjusted start time: {self.app_start_time_dt})
